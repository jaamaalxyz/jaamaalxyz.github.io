export const ALL_POSTS = [
  ...
  },
  {
    ...
    readingTime: '2',
    summary:
      'Creating a simple tap gesture in SwiftUI is quite straightforward. Here’s a basic example of how you can add a tap gesture to a text…',
  ...
  },
  {
    ...
    readingTime: '4',
    summary:
      'In the mobile-first world, ensuring that users have a seamless experience even when they’re offline is crucial. An offline alert is…',
  ...
  },
  {
    ...
    readingTime: '11',
    summary:
      'Data fetching is an essential part of mobile app development, as it allows us to communicate with external sources, such as APIs…',
  ...
  },
  {
    ...
    readingTime: '8',
    summary:
      'State management is a crucial aspect of any application development, especially for complex and dynamic apps that need to share data…',
  ...
  },
  {
    ...
    readingTime: '7',
    summary:
      'Types are a way of describing the shape and behavior of data in our code. They can help us avoid common errors, such as passing the wrong…',
  ...
  },
  {
    ...
    readingTime: '6',
    summary:
      'Welcome, all aspiring mobile app developers! Today, we will have a delightful journey to build engaging React Native apps using its…',
  ...
  },
  {
    ...
    readingTime: '6',
    summary:
      'Forms are a crucial component of web development, allowing users to interact with websites. Creating forms that are not only visually…',
  ...
  },
  {
    ...
    readingTime: '4',
    summary:
      'Ever dreamed of turning your brilliant app idea into a reality? Well, guess what? You’re not alone! Mobile app development has become a…',
  ...
  },
  {
    ...
    readingTime: '12',
    summary:
      'Welcome to your journey in creating eye-catching and accessible buttons in React Native in an Expo-managed project! In this step-by-step…',
  ...
  },
  {
    ...
    readingTime: '6',
    summary:
      'The CSS box model is a fundamental concept in web development that defines the structure and layout of HTML elements. It comprises the…',
  ...
  },
  {
    ...
    readingTime: '4',
    summary:
      'Welcome to the vibrant world of Swift! Developed by Apple in 2014, Swift is not just a programming language; it is a companion on your…',
  ...
  },
  {
    ...
    readingTime: '5',
    summary:
      'Welcome to the enchanting world of iOS development, where Swift programming is the key to creating magical applications for Apple devices…',
  ...
  },
  {
    ...
    readingTime: '6',
    summary:
      'Semantic HTML is a fundamental concept in web development. In this article, we will...',
  ...
  },
  {
    ...
    readingTime: '5',
    summary:
      'HTML and CSS are two of the most fundamental building blocks of the internet. HTML, which stands for HyperText Markup Language, is the…',
  ...
  },
  {
    ...
    readingTime: '3',
    summary:
      "Productivity books have become increasingly popular in today's fast-paced world.With so many demands on our time and attention, people are…",
  ...
  },
  {
    ...
    readingTime: '4',
    summary:
      'Love for Imperfect Things: How to Accept Yourself in a World Striving for Perfection is a self-help book by Haemin Sunim, a Zen Buddhist…',
  ...
  },
  {
    ...
    readingTime: '5',
    summary:
      'Generating PDF based on different transaction is an important part of any retail applications. today we are going to show...',
  ...
  },
  {
    ...
    readingTime: '3',
    summary:
      'SQL, short for Structured Query Language, is your gateway to relational databases.  It lets you create and manage data stored in tables...',
  ...
  },
  {
    ...
    readingTime: '3',
    summary:
      'SQL lets you manage data in three key steps: Create tables defining data structure, insert new records with values, and retrieve data...',
  ...
  },
  {
    ...
    readingTime: '3',
    summary:
      'In the world of computers, hardware is the physical parts and software are the instructions that make the computer work...',
    url: '',
  },
  {
    ...
    readingTime: '5',
    summary:
      'SQL lets you filter data using the WHERE clause. This clause specifies conditions that rows must meet to be included in the results. You can filter based on equality...',
    url: '',
  },
  {
...

  {
    ...
    readingTime: '8',
    summary:
      'This article prepares you for frontend developer interviews by providing 25 common questions and answers',
  ...
  },
  {
    ...
    readingTime: '6',
    summary:
      'JavaScript offers a toolbox of functions! Regular functions are your workhorses, arrow functions provide a shorthand for quick tasks...',
