![jaamaal-dot-com-site-banner](/public/static/images/twitter-card.png)

# Personal Portfolio and Blog site of Md. Jamal Uddin
## Used Tailwind Nextjs Starter Blog

[![GitHub Repo stars](https://img.shields.io/github/stars/jaamaalxyz/jaamaalxyz.github.io?style=social)](https://GitHub.com/jaamaalxyz/jaamaalxyz/stargazers/)
[![GitHub forks](https://img.shields.io/github/forks/jaamaalxyz/jaamaalxyz.github.io?style=social)](https://GitHub.com/jaamaalxyz/jaamaalxyz.github.io/network/)
[![Twitter URL](https://img.shields.io/twitter/url?style=social&url=https%3A%2F%2Ftwitter.com%2Fjaamaalxyz)](https://twitter.com/jaamaalxyz)

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https://github.com/jaamaalxyz/jaamaalxyz.github.io)

This is a personal blog website built on top of [Next.js](https://nextjs.org/), [Tailwind CSS](https://tailwindcss.com/). Based on Next App directory with [React Server Component](https://nextjs.org/docs/getting-started/react-essentials#server-components) and uses [Contentlayer](https://www.contentlayer.dev/) to manage markdown content.
...
```bash
git clone git@github.com:jaamaalxyz/jaamaalxyz.github.io.git
```
...
[MIT](https://github.com/jaamaalxyz/jaamaalxyz/blob/main/LICENSE) © [Md. Jamal Uddin](https://jaamaal.com)
